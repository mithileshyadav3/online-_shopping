...
<img src='./Admin/product_img/$product_image2'  class='card-img-top'>
            </div>
            <div class='col-md-6 mt-5'>
           <img src='./Admin/product_img/$product_image3'  class='card-img-top'>
            </div>
      </div>
</div>  
                  ";
      ...
      //   $ip = getIPAddress();  
      //   echo 'User Real IP Address - '.$ip;  ...end
// cart
function cart(){
